package com.ewertonilima.notificationhex.adapters.inbound.controllers;

import com.ewertonilima.notificationhex.adapters.dtos.NotificationDto;
...
public class UserNotificationController {
    ...
    public ResponseEntity<Page<NotificationDomain>> getAllNotificationsByUser(@PathVariable(value = "userId") UUID userid,
        ...
        List<NotificationDomain> notificationDomainList = notificationServicePort.findAllNotificationByUser(userid,
                pageInfo);
        return ResponseEntity.status(HttpStatus.OK).body(new PageImpl<NotificationDomain>(notificationDomainList,
                pageable,
